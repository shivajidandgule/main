...
const Userpg = () => {
  ...
  return (
    ...
    <Container className='w-100'>
     <Form >
      ...
      <Button  style={{alignSelf:'end'}} onClick={handlebutton} className=" h-25">{userdisable ? 'Edit' :'Save'}</Button>
         
     <Row className="mb-15 mt-2 ">
    <Form.Group as={Col} >
      
      <Form.Control disabled={userdisable}  type="test" placeholder="last name" />
    </Form.Group>
  ...
  <Row className="mb-5 ">
    ...
    <Form.Group as={Col} >
      ...
      <Form.Control disabled={cordisable} type="number" placeholder="Zip" />
    </Form.Group>
